...
The `gdm` package has been updated to leverage the [`terra`](https://cran.r-project.org/web/packages/terra/index.html) package as its raster processing engine, leading to faster raster file processing. Preferably, inputs should be provided as `SpatRaster` objects, or any convertible object to `terra`, such as [`raster`](https://cran.r-project.org/web/packages/raster/index.html) package objects or [`stars`](https://cran.r-project.org/package=stars) objects.
